...
i18n.translations = {
  en: {
    ...
    toolkit_subtitle: "Carbon Reporting Toolkit",
  ...
  hi: {
    ...
    toolkit_subtitle: "कार्बन रिपोर्टिंग टूलकिट",
    agriculture: "कृषि",
  ...
  es: {
    ...
    toolkit_subtitle: "Kit de herramientas de informes de carbono",
  ...
  fr: {
    ...
    toolkit_subtitle: "Boîte à outils de reporting carbone",
    agriculture: "Agriculture",
